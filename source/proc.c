...
int ReadInt32(int pid, u64 offset)
{
	int var;
...
u32 ReadUint32(int pid, u64 offset)
{
	u32 var;
	procReadBytes(pid, (void*)offset, (void*)&var, sizeof(var));
	return var;
...
long long ReadInt64(int pid, u64 offset)
{
	long long var;
	procReadBytes(pid, (void*)offset, (void*)&var, sizeof(var));
	return var;
...
u64 ReadUint64(int pid, u64 offset)
{
	u64 var;
	procReadBytes(pid, (void*)offset, (void*)&var, sizeof(var));
	return var;
...
char* ReadString(int pid, u64 offset, char * buffer)
{
	procReadBytes(pid, (void*)offset, (void*)buffer, 0x40);
	return buffer;
}

void WriteInt32(int pid, u64 offset, int var)
{
	procWriteBytes(pid, (void*)offset, (void*)&var, sizeof(var));
}

void WriteUint32(int pid, u64 offset, u32 var)
{
	procWriteBytes(pid, (void*)offset, (void*)&var, sizeof(var));
}

void WriteInt64(int pid, u64 offset, long long var)
{
	procWriteBytes(pid, (void*)offset, (void*)&var, sizeof(var));
}

void WriteUint64(int pid, u64 offset, u64 var)
{
	procWriteBytes(pid, (void*)offset, (void*)&var, sizeof(var));
}

void WriteString(int pid, u64 offset, const char * var)
{
	procWriteBytes(pid, (void*)offset, (void*)var, strlen(var) + 1);
}

void WriteBytes(int pid, u64 offset, u8 var[])
{
	procWriteBytes(pid, (void*)offset, (void*)var, 3);
}

void WriteBytes2(int pid, u64 offset, u8 *var, size_t len)
{
